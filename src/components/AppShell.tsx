  ...
  return (
    <div className="min-h-screen w-full bg-background text-foreground">
      <motion.aside
        ...
        className="hidden md:flex flex-col fixed inset-y-0 left-0 z-30 bg-sidebar border-r border-sidebar-border overflow-hidden"
      >
...
function Topbar({
  onMobileOpen, onCollapseToggle, theme, toggle, profileOpen, setProfileOpen,
}: {
  onMobileOpen: () => void;
  ...
  return (
    <header className="sticky top-0 z-20 h-14 bg-background/80 backdrop-blur border-b border-border flex items-center gap-3 px-4">
      <button className="md:hidden p-2 rounded-md hover:bg-accent" onClick={onMobileOpen} aria-label="Open menu">
        <Menu className="w-5 h-5" />
      </button>
      <button className="hidden md:inline-flex p-2 rounded-md hover:bg-accent transition-colors" onClick={onCollapseToggle} aria-label="Toggle sidebar">
        <Menu className="w-5 h-5" />
      </button>
